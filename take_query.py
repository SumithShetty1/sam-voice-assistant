...
def take_query():
    ...
    while True:
        with open("ui/web/response.txt", "a", encoding="utf-8") as file:
            file.write(response)  # Append response to the file
        ...
        if "tell me your name" in query or "who are you" in query:
            ...
            print(
                "Sam: As your assistant, sir, I can handle tasks like managing settings, searching the web, opening apps, and more.")
            speak(
                "As your assistant sir I can handle tasks like managing settings searching the web opening apps and more")
